...
function CartWidget(){
    return(
        <>
            {/* <button id="carrito" className=" btn btn-dark text-success p-2 mx-3" type="button" data-bs-toggle="offcanvas" data-bs-target="#staticBackdrop" aria-controls="staticBackdrop">
